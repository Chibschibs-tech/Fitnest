        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="flex items-center mb-4">
              <span className="text-2xl font-bold text-green-500">Fitnest</span>
              <span className="text-2xl font-bold text-white">.ma</span>
            </Link>
            <p className="text-gray-400 mb-4">
              Delicious and nutritious meal plans delivered to your door. Eat healthy without the hassle.
            </p>
